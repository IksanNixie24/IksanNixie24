...
<div class="content read">
	...
	<table>
        ...
        <tbody>
            ...
            <tr>
                <td><?=$contact['id']?></td>
                <td><?=$contact['no_buku']?></td>
                <td><?=$contact['nama_buku']?></td>
                <td><?=$contact['jumlah_halaman']?></td>
                <td><?=$contact['tahun_terbit']?></td>
                <td><?=$contact['nama_pengarang']?></td>
                <td><?=$contact['genre']?></td>
                <td class="actions">
